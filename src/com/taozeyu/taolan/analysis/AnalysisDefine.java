...
class AnalysisDefine {
    ...
    static {
        ...
        creator(new Exp[]{Exp.L1Expression, Exp.L1ParamExpression}, new ElementNodeSupplier() {
            public AnalysisNode get() {
                return new ExpressionNode() {
        ...
        creator(new Exp[]{Exp.Command}, new ElementNodeSupplier() {
            public AnalysisNode get() {
        ...
        creator(new Exp[]{Exp.DefineFunction}, new ElementNodeSupplier() {
            public AnalysisNode get() {
        ...
        creator(new Exp[]{Exp.IfElseChunk}, new ElementNodeSupplier() {
            public AnalysisNode get() {
        ...
        creator(new Exp[]{Exp.When}, new ElementNodeSupplier() {
            public AnalysisNode get() {
                return new WhenNode() {
        ...
        creator(new Exp[]{Exp.TryCatch}, new ElementNodeSupplier() {
            public AnalysisNode get() {
        ...
        creator(new Exp[]{Exp.WhileChunk}, new ElementNodeSupplier() {
            public AnalysisNode get() {
        ...
        creator(new Exp[]{Exp.DoUntilChunk}, new ElementNodeSupplier() {
            public AnalysisNode get() {
                return new LoopChunkNode() {
                    {
                        isWhile = false;
        ...
        creator(new Exp[]{Exp.ForEachCommand}, new containerNodeSupplier());
        creator(new Exp[]{Exp.ForEachChunk}, new ElementNodeSupplier() {
            public AnalysisNode get() {
        ...
        creator(new Exp[]{Exp.Lambda}, new ElementNodeSupplier() {
            public AnalysisNode get() {
